  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: SIZES.xLarge }}>
      ...
      >
        ...
        <Text style={styles.productPrice}>{convertToCurrency(selectedProduct.price)}</Text>
        {selectedProduct.item_type === 'subscription' && (
      ...
      {selectedProduct.sizes && selectedProduct.sizes.length > 0 && (
        ...
        >
          ...
          {selectedProduct.sizes.map((size) => {
            const variant = selectedProduct.variants.find(v => v.title === size);
            return (
              <View key={size} style={styles.sizingItem}>
                ...
                <Text style={styles.sizingPrice}>
                  {convertToCurrency(variant?.price || selectedProduct.price)}
                </Text>
              </View>
            );
          })}
