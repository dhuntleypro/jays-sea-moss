...
declare function TabLayoutContent(): react_jsx_runtime.JSX.Element;
...
declare const authApi: {
    ...
    post: <T_1 = any>(endpoint: string, body: any, options?: Omit<RequestInit, "method" | "body"> & {
        params?: Record<string, string | number> | undefined;
    }) => Promise<T_1>;
    patch: <T_2 = any>(endpoint: string, body: any, options?: Omit<RequestInit, "method" | "body"> & {
        params?: Record<string, string | number> | undefined;
    }) => Promise<T_2>;
    put: <T_3 = any>(endpoint: string, body: any, options?: Omit<RequestInit, "method" | "body"> & {
        params?: Record<string, string | number> | undefined;
    }) => Promise<T_3>;
...
declare const deleteUserApi: ({ id }: {
    id: any;
}) => Promise<any>;
